...
const THEMES = {
  light: {
    ...
    text: '#232730', dim: '#53575d', faint: '#64686d', axis: '#64686d',
    ghost: '#54575c', ghostArt: '#b6bcc4',
    sky0: '#e3e7ec', sky1: '#edeef1', sky2: '#f0f1f3',
    ground0: '#dedbd6', ground1: '#cfccc6', horizon: '#edeef1',
    stone: '#8b9099', haze: '#e8eaed',
  ...
  dark: {
    name: 'dark',
    ink: '#e7e9ec', grid: '#e7e9ec', gridOp: 1,
    text: '#e8e6e1', dim: '#aab1bb', faint: '#8f97a1', axis: '#858d97',
    ghost: '#8b939d', ghostArt: '#39404a',
    sky0: '#171a21', sky1: '#15181c', sky2: '#16191d',
    ground0: '#242931', ground1: '#1b1f25', horizon: '#15181c',
    stone: '#6f7783', haze: '#1a1e25',
